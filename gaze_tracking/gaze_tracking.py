...
class GazeTracking(object):
    ...
    def pupil_left_coords_eye_only(self):
        """Returns the coordinates of the left pupil without movement of face"""
        if self.pupils_located:
            x = self.eye_left.pupil.x
            y = self.eye_left.pupil.y
            return (x, y)

    def pupil_right_coords_eye_only(self):
        """Returns the coordinates of the right pupil without movement of face"""
        if self.pupils_located:
            x = self.eye_right.pupil.x
            y = self.eye_right.pupil.y
            return (x, y)

    def pupil_left_coords_head_only(self):
    ...
    def pupil_right_coords_head_only(self):
    ...
    def is_right(self):
        ...
        if self.pupils_located:
            return self.horizontal_ratio() <= 0.58 # Original value: 0.50

    def is_left(self):
        """Returns true if the user is looking to the left"""
        if self.pupils_located:
            return self.horizontal_ratio() >= 0.65 # Original value: 0.50
